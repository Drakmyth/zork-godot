...
class Verbs:
	const ALL_WORDS = [ ACTIVATE, ANSWER, APPLY, ATTACK, BACK, BLAST, BLOW, BOARD, BRUSH, BUG, BURN, CHOMP, CLIMB, CLOSE, COMMAND, COUNT, CROSS, CUT, CURSE, DEFLATE, DESTROY, DIAGNOSE, DIG, DISEMBARK, DISENCHANT, DRINK, DROP, EAT, ECHO, ENCHANT, ENTER, EXIT, EXAMINE, EXORCISE, EXTINGUISH, FILL, FIND, FOLLOW, FROBOZZ, GIVE, HATCH, HELLO, INCANT, INFLATE, JUMP, KICK, KILL, STAB, KISS, KNOCK, LAUNCH, LEAN, LEAVE, LIGHT, LISTEN, LOCK, LOOK, LOWER, LUBRICATE, MAKE, MELT, MOVE, ROLL, MUMBLE, ODYSSEUS, OPEN, PICK, PLAY, PLUG, PLUGH, POKE, PUNCTURE, POUR, PRAY, PULL, PUMP, PUSH, PUT, RAISE, RAPE, READ, REPENT, RING, RUB, TALK, SAY, SCORE, SEARCH, SEND, SHAKE, SKIP, SLIDE, SMELL, SPIN, SPRAY, SQUEEZE, STAND, STAY, STRIKE, SWIM, SWING, TAKE, TELL, THROW, TIE, TREASURE, TURN, UNLOCK, UNTIE, WAIT, WAKE, WALK, WAVE, WEAR, WIN, WIND, WISH, YELL, ZORK ]
